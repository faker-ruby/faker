...
module Faker
  class Lovecraft < Base
    class << self
      ...
      deprecate :location, 'Faker::Books::Lovecraft.location', 2019, 0o1
      deprecate :fhtagn, 'Faker::Books::Lovecraft.fhtagn', 2019, 0o1
      deprecate :deity, 'Faker::Books::Lovecraft.deity', 2019, 0o1
      deprecate :tome, 'Faker::Books::Lovecraft.tome', 2019, 0o1
      deprecate :sentence, 'Faker::Books::Lovecraft.sentence', 2019, 0o1
      deprecate :word, 'Faker::Books::Lovecraft.word', 2019, 0o1
      deprecate :words, 'Faker::Books::Lovecraft.words', 2019, 0o1
      deprecate :sentences, 'Faker::Books::Lovecraft.sentences', 2019, 0o1
      deprecate :paragraph, 'Faker::Books::Lovecraft.paragraph', 2019, 0o1
      deprecate :paragraphs, 'Faker::Books::Lovecraft.paragraphs', 2019, 0o1
      deprecate :paragraph_by_chars, 'Faker::Books::Lovecraft.paragraph_by_chars', 2019, 0o1
    end
  end
end
