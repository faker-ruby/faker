...
module Faker
  class LoremPixel < Base
    class << self
      ...
      #
      # @faker.version 1.7.0
      def image(_legacy_size = NOT_GIVEN, _legacy_is_gray = NOT_GIVEN, _legacy_category = NOT_GIVEN, _legacy_number = NOT_GIVEN, _legacy_text = NOT_GIVEN, _legacy_secure = NOT_GIVEN, size: '300x300', is_gray: false, category: nil, number: nil, text: nil, secure: true)
