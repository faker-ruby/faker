...
module Faker
  class Code < Base
    ...
    class << self
      ...
      #
      # @faker.version 2.2.0
      def isbn(_legacy_base = NOT_GIVEN, base: 10)
        case base
      ...
      #
      # @faker.version 2.2.0
      def ean(_legacy_base = NOT_GIVEN, base: 13)
        case base
      ...
      #
      # @faker.version 2.2.0
      def nric(_legacy_min_age = NOT_GIVEN, _legacy_max_age = NOT_GIVEN, min_age: 18, max_age: 65)
