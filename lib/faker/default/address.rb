...
module Faker
  class Address < Base
    ...
    class << self
      ...
      #
      # @faker.version 0.3.0
      def city(_legacy_options = NOT_GIVEN, options: {})
      ...
      #
      # @faker.version 0.3.0
      def street_address(_legacy_include_secondary = NOT_GIVEN, include_secondary: false)
      ...
      #
      # @faker.version 0.3.0
      def zip_code(_legacy_state_abbreviation = NOT_GIVEN, state_abbreviation: '')
      ...
      #
      # @faker.version 1.9.2
      def country_by_code(_legacy_code = NOT_GIVEN, code: 'US')
      ...
      #
      # @faker.version 1.9.2
      def country_name_to_code(_legacy_name = NOT_GIVEN, name: 'united_states')
