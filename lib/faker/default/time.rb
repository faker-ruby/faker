...
module Faker
  class Time < Base
    ...
    class << self
      ...
      #
      # @faker.version 1.5.0
      def between(_legacy_from = NOT_GIVEN, _legacy_to = NOT_GIVEN, _legacy_format = NOT_GIVEN, from:, to:, format: nil)
      ...
      #
      # @faker.version 1.0.0
      def between_dates(_legacy_from = NOT_GIVEN, _legacy_to = NOT_GIVEN, _legacy_period = NOT_GIVEN, _legacy_format = NOT_GIVEN, from:, to:, period: :all, format: nil)
      ...
      #
      # @faker.version 1.5.0
      def forward(_legacy_days = NOT_GIVEN, _legacy_period = NOT_GIVEN, _legacy_format = NOT_GIVEN, days: 365, period: :all, format: nil)
      ...
      #
      # @faker.version 1.5.0
      def backward(_legacy_days = NOT_GIVEN, _legacy_period = NOT_GIVEN, _legacy_format = NOT_GIVEN, days: 365, period: :all, format: nil)
