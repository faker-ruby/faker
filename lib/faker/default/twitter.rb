...
module Faker
  class Twitter < Base
    class << self
      ...
      #
      # @faker.version 1.7.3
      def user(_legacy_include_status = NOT_GIVEN, _legacy_include_email = NOT_GIVEN, include_status: true, include_email: false)
        user_id = id
      ...
      #
      # @faker.version 1.7.3
      def status(_legacy_include_user = NOT_GIVEN, _legacy_include_photo = NOT_GIVEN, include_user: true, include_photo: false)
        status_id = id
        status = {
          id: status_id,
      ...
      def status_entities(_legacy_include_photo = NOT_GIVEN, include_photo: false)
        entities = {
          hashtags: [],
          symbols: [],
          user_mentions: [],
