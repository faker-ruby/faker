...
module Faker
  class Vehicle < Base
    ...
    class << self
      ...
      #
      # @faker.version 1.6.4
      def model(_legacy_make_of_model = NOT_GIVEN, make_of_model: '')
      ...
      #
      # @faker.version 1.6.4
      def mileage(_legacy_min = NOT_GIVEN, _legacy_max = NOT_GIVEN, min: MILEAGE_MIN, max: MILEAGE_MAX)
      ...
      #
      # @faker.version 1.6.4
      def license_plate(_legacy_state_abbreviation = NOT_GIVEN, state_abbreviation: '')
