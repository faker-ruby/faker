...
module Faker
  class Commerce < Base
    class << self
      ...
      #
      # @faker.version 1.7.0
      def promotion_code(_legacy_digits = NOT_GIVEN, digits: 6)
        [
      ...
      #
      # @faker.version 1.2.0
      def department(_legacy_max = NOT_GIVEN, _legacy_fixed_amount = NOT_GIVEN, max: 3, fixed_amount: false)
      ...
      #
      # @faker.version 1.2.0
      def price(_legacy_range = NOT_GIVEN, _legacy_as_string = NOT_GIVEN, range: 0..100.0, as_string: false)
