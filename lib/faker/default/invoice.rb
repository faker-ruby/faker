...
module Faker
  class Invoice < Base
    ...
    class << self
      ...
      #
      # @faker.version 1.9.0
      def amount_between(_legacy_from = NOT_GIVEN, _legacy_to = NOT_GIVEN, from: 0, to: 0)
      ...
      #
      # @faker.version 1.9.0
      def creditor_reference(_legacy_ref = NOT_GIVEN, ref: '')
      ...
      #
      # @faker.version 1.9.0
      def reference(_legacy_ref = NOT_GIVEN, ref: '')
