...
module Faker
  class Types < Base
    ...
    class << self
      ...
      #
      # @faker.version 1.8.6
      def rb_string(_legacy_words = NOT_GIVEN, words: 1)
      ...
      #
      # @faker.version 1.8.6
      def rb_integer(_legacy_from = NOT_GIVEN, _legacy_to = NOT_GIVEN, from: 0, to: 100)
        rand(from..to).to_i
      end
      ...
      #
      # @faker.version 1.8.6
      def rb_hash(_legacy_number = NOT_GIVEN, _legacy_type = NOT_GIVEN, number: 1, type: -> { random_type })
        {}.tap do |hsh|
      ...
      #
      # @faker.version 1.8.6
      def complex_rb_hash(_legacy_number = NOT_GIVEN, number: 1)
      ...
      #
      # @faker.version 1.8.6
      def rb_array(_legacy_len = NOT_GIVEN, len: 1)
        [].tap do |ar|
          len.times do
            ar.push random_type
          end
