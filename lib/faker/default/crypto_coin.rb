...
module Faker
  class CryptoCoin < Base
    class << self
      ...
      #
      # @faker.version 1.9.2
      def coin_name(_legacy_coin = NOT_GIVEN, coin: coin_array)
        coin[COIN_NAME]
      end
      ...
      #
      # @faker.version 1.9.2
      def acronym(_legacy_coin = NOT_GIVEN, coin: coin_array)
        coin[ACRONYM]
      end
      ...
      #
      # @faker.version 1.9.2
      def url_logo(_legacy_coin = NOT_GIVEN, coin: coin_array)
        coin[URL_LOGO]
      end
