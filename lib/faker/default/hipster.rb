...
module Faker
  class Hipster < Base
    class << self
      ...
      #
      # @faker.version 1.6.0
      def words(_legacy_number = NOT_GIVEN, _legacy_supplemental = NOT_GIVEN, _legacy_spaces_allowed = NOT_GIVEN, number: 3, supplemental: false, spaces_allowed: false)
      ...
      #
      # @faker.version 1.6.0
      def sentence(_legacy_word_count = NOT_GIVEN, _legacy_supplemental = NOT_GIVEN, _legacy_random_words_to_add = NOT_GIVEN, word_count: 4, supplemental: false, random_words_to_add: 6, open_compounds_allowed: true)
      ...
      #
      # @faker.version 1.6.0
      def paragraph(_legacy_sentence_count = NOT_GIVEN, _legacy_supplemental = NOT_GIVEN, _legacy_random_sentences_to_add = NOT_GIVEN, sentence_count: 3, supplemental: false, random_sentences_to_add: 3)
      ...
      #
      # @faker.version 1.6.0
      def paragraph_by_chars(_legacy_characters = NOT_GIVEN, _legacy_supplemental = NOT_GIVEN, characters: 256, supplemental: false)
