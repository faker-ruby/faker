...
module Faker
  class Number < Base
    class << self
      ...
      #
      # @faker.version 1.0.0
      def number(_legacy_digits = NOT_GIVEN, digits: 10)
        return if digits < 1
      ...
      #
      # @faker.version 1.0.0
      def leading_zero_number(_legacy_digits = NOT_GIVEN, digits: 10)
      ...
      #
      # @faker.version 1.0.0
      def decimal_part(_legacy_digits = NOT_GIVEN, digits: 10)
        num = ''
        if digits > 1
          num = non_zero_digit
          digits -= 1
      ...
      #
      # @faker.version 1.0.0
      def decimal(_legacy_l_digits = NOT_GIVEN, _legacy_r_digits = NOT_GIVEN, l_digits: 5, r_digits: 2)
      ...
      #
      # @faker.version 1.0.0
      def hexadecimal(_legacy_digits = NOT_GIVEN, digits: 6)
        hex = ''
      ...
      #
      # @faker.version 1.0.0
      def normal(_legacy_mean = NOT_GIVEN, _legacy_standard_deviation = NOT_GIVEN, mean: 1, standard_deviation: 1)
      ...
      #
      # @faker.version 1.0.0
      def between(_legacy_from = NOT_GIVEN, _legacy_to = NOT_GIVEN, from: 1.00, to: 5000.00)
      ...
      #
      # @faker.version 1.0.0
      def within(_legacy_range = NOT_GIVEN, range: 1.00..5000.00)
      ...
      #
      # @faker.version 1.0.0
      def positive(_legacy_from = NOT_GIVEN, _legacy_to = NOT_GIVEN, from: 1.00, to: 5000.00)
      ...
      #
      # @faker.version 1.0.0
      def negative(_legacy_from = NOT_GIVEN, _legacy_to = NOT_GIVEN, from: -5000.00, to: -1.00)
        random_number = between(from: from, to: to)
