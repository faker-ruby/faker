...
module Faker
  class ChileRut < Base
    class << self
      ...
      #
      # @faker.version 1.9.2
      def rut(_legacy_min_rut = NOT_GIVEN, _legacy_fixed = NOT_GIVEN, min_rut: 1, fixed: false)
      ...
      #
      # @faker.version next
      def full_rut(_legacy_min_rut = NOT_GIVEN, _legacy_fixed = NOT_GIVEN, min_rut: 0, fixed: false, formatted: false)
        if formatted
