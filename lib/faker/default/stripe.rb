...
module Faker
  class Stripe < Base
    class << self
      ...
      #
      # @faker.version 1.9.0
      def valid_card(_legacy_card_type = NOT_GIVEN, card_type: nil)
      ...
      #
      # @faker.version 1.9.0
      def valid_token(_legacy_card_type = NOT_GIVEN, card_type: nil)
      ...
      #
      # @faker.version 1.9.0
      def invalid_card(_legacy_card_error = NOT_GIVEN, card_error: nil)
      ...
      #
      # @faker.version 1.9.0
      def ccv(_legacy_card_type = NOT_GIVEN, card_type: nil)
