...
module Faker
  class Measurement < Base
    class << self
      ...
      #
      # @faker.version 1.7.3
      def height(_legacy_amount = NOT_GIVEN, amount: rand(10))
      ...
      #
      # @faker.version 1.7.3
      def length(_legacy_amount = NOT_GIVEN, amount: rand(10))
      ...
      #
      # @faker.version 1.7.3
      def volume(_legacy_amount = NOT_GIVEN, amount: rand(10))
      ...
      #
      # @faker.version 1.7.3
      def weight(_legacy_amount = NOT_GIVEN, amount: rand(10))
      ...
      #
      # @faker.version 1.7.3
      def metric_height(_legacy_amount = NOT_GIVEN, amount: rand(10))
      ...
      #
      # @faker.version 1.7.3
      def metric_length(_legacy_amount = NOT_GIVEN, amount: rand(10))
      ...
      #
      # @faker.version 1.7.3
      def metric_volume(_legacy_amount = NOT_GIVEN, amount: rand(10))
      ...
      #
      # @faker.version 1.7.3
      def metric_weight(_legacy_amount = NOT_GIVEN, amount: rand(10))
