  ...
  class Books
    class Lovecraft < Base
      class << self
        ...
        #
        # @faker.version 1.9.3
        def fhtagn(_legacy_number = NOT_GIVEN, number: 1)
        ...
        #
        # @faker.version 1.9.3
        def sentence(_legacy_word_count = NOT_GIVEN, _legacy_random_words_to_add = NOT_GIVEN, word_count: 4, random_words_to_add: 6, open_compounds_allowed: true)
        ...
        #
        # @faker.version 1.9.3
        def words(_legacy_number = NOT_GIVEN, _legacy_spaces_allowed = NOT_GIVEN, number: 3, spaces_allowed: false)
        ...
        #
        # @faker.version 1.9.3
        def sentences(_legacy_number = NOT_GIVEN, number: 3)
          [].tap do |sentences|
        ...
        #
        # @faker.version 1.9.3
        def paragraph(_legacy_sentence_count = NOT_GIVEN, _legacy_random_sentences_to_add = NOT_GIVEN, sentence_count: 3, random_sentences_to_add: 3)
        ...
        #
        # @faker.version 1.9.3
        def paragraphs(_legacy_number = NOT_GIVEN, number: 3)
          [].tap do |paragraphs|
            1.upto(resolve(number)) do
        ...
        #
        # @faker.version 1.9.3
        def paragraph_by_chars(_legacy_characters = NOT_GIVEN, characters: 256)
