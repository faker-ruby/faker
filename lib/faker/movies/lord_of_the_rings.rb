  ...
  class Movies
    class LordOfTheRings < Base
      class << self
        ...
        # @faker.version 1.7.0
        def character
          fetch('tolkien_legendarium.lord_of_the_rings.characters')
        end
        ...
        # @faker.version 1.7.0
        def location
          fetch('tolkien_legendarium.lord_of_the_rings.locations')
        end
        ...
        # @faker.version 1.9.0
        def quote
          fetch('tolkien_legendarium.lord_of_the_rings.quotes')
        end
      end
    end
  end
