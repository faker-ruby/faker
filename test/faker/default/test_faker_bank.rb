...
class TestFakerBank < Test::Unit::TestCase
  ...
  def test_routing_number
    ...
    assert_match routing_number, /\d{9}/
    assert_equal(0, checksum)
  end

  def test_routing_number_with_format
    fraction = Faker::Bank.routing_number_with_format
    assert_match fraction, /\d{1,2}-\d{1,4}\/\d{1,4}/
  end

  def test_bsb_number
    assert_match Faker::Bank.bsb_number, /\d{6}/
  end

  def test_account_number
    assert_match Faker::Bank.account_number, /\d{10}/

    assert_match Faker::Bank.account_number(digits: 12), /\d{12}/

    assert_match Faker::Bank.account_number(digits: 100), /\d{100}/
  end
  ...
  def test_swift_bic
    assert_match @tester.swift_bic, /(\w+\.? ?){2,3}/
  end
  ...
  def test_iban_ad
    ...
    assert_match account, /^#{IBAN_HEADER}\d{8}[A-Z0-9]{12}$/
  end
  ...
  def test_iban_ae
    ...
    assert_match account, /^#{IBAN_HEADER}\d{19}$/
  end
  ...
  def test_iban_al
    ...
    assert_match account, /^#{IBAN_HEADER}\d{8}[A-Z0-9]{16}$/
  end
  ...
  def test_iban_at
    ...
    assert_match account, /^#{IBAN_HEADER}\d{16}$/
  end
  ...
  def test_iban_az
    ...
    assert_equal(28, account.length)
    assert_match account, /^#{IBAN_HEADER}[A-Z]{4}[A-Z0-9]{20}$/
  end
  ...
  def test_iban_be
    ...
    assert_match account, /^#{IBAN_HEADER}\d{12}$/
  end
  ...
  def test_iban_bg
    ...
    assert_match account, /^#{IBAN_HEADER}[A-Z]{4}\d{6}[A-Z0-9]{8}$/
  end
  ...
  def test_iban_bh
    ...
    assert_equal(22, account.length)
    assert_match account, /^#{IBAN_HEADER}[A-Z]{4}[A-Z0-9]{14}$/
  end
  ...
  def test_iban_br
    ...
    assert_match account, /^#{IBAN_HEADER}[0-9]{8}[0-9]{5}[0-9]{10}[A-Z]{1}[A-Z0-9]{1}$/
  end
  ...
  def test_iban_ch
    ...
    assert_match account, /^#{IBAN_HEADER}\d{5}[A-Z0-9]{12}$/
  end
  ...
  def test_iban_cr
    ...
    assert_equal(22, account.length)
    assert_match account, /^#{IBAN_HEADER}0\d{3}\d{14}$/
  end
  ...
  def test_iban_cz
    ...
    assert_equal(24, account.length)
    assert_match account, /^#{IBAN_HEADER}\d{20}$/
  end
  ...
  def test_iban_de
    ...
    assert_equal(22, account.length)
    assert_match account, /^#{IBAN_HEADER}\d{18}$/
  end
  ...
  def test_iban_dk
    ...
    assert_match account, /^#{IBAN_HEADER}\d{14}$/
  end
  ...
  def test_iban_do
    ...
    assert_equal(28, account.length)
    assert_match account, /^#{IBAN_HEADER}[A-Z]{4}\d{20}$/
  end
  ...
  def test_iban_fr
    ...
    assert_match account, /^#{IBAN_HEADER}\d{10}[A-Z0-9]{11}\d{2}$/
  end
  ...
  def test_iban_gb
    ...
    assert_equal(22, account.length)
    assert_match account, /^#{IBAN_HEADER}[A-Z]{4}\d{14}$/
  end
  ...
  def test_iban_ge
    ...
    assert_equal(22, account.length)
    assert_match account, /^#{IBAN_HEADER}[A-Z]{2}\d{16}$/
  end
  ...
  def test_iban_gi
    ...
    assert_equal(23, account.length)
    assert_match account, /^#{IBAN_HEADER}[A-Z]{4}[A-Z0-9]{15}$/
  end
  ...
  def test_iban_gr
    ...
    assert_equal(27, account.length)
    assert_match account, /^#{IBAN_HEADER}\d{7}[A-Z0-9]{16}$/
  end
  ...
  def test_iban_gt
    ...
    assert_equal(28, account.length)
    assert_match account, /^#{IBAN_HEADER}[A-Z0-9]{4}\d{2}\d{2}[A-Z0-9]{16}$/
  end
  ...
  def test_iban_hr
    ...
    assert_equal(21, account.length)
    assert_match account, /^#{IBAN_HEADER}\d{17}$/
  end
  ...
  def test_iban_hu
    ...
    assert_equal(28, account.length)
    assert_match account, /^#{IBAN_HEADER}\d{24}$/
  end
  ...
  def test_iban_is
    ...
    assert_match account, /^#{IBAN_HEADER}\d{22}$/
  end
  ...
  def test_iban_it
    ...
    assert_equal(27, account.length)
    assert_match account, /^#{IBAN_HEADER}[A-Z]\d{10}[A-Z0-9]{12}$/
  end
  ...
  def test_iban_kw
    ...
    assert_match account, /^#{IBAN_HEADER}[A-Z]{4}\d{22}$/
  end
  ...
  def test_iban_kz
    ...
    assert_equal(20, account.length)
    assert_match account, /^#{IBAN_HEADER}[0-9]{3}[A-Z0-9]{13}$/
  end
  ...
  def test_iban_lb
    ...
    assert_equal(28, account.length)
    assert_match account, /^#{IBAN_HEADER}\d{4}[A-Z0-9]{20}$/
  end
  ...
  def test_iban_lu
    ...
    assert_equal(20, account.length)
    assert_match account, /^#{IBAN_HEADER}\d{3}[A-Z0-9]{13}$/
  end
  ...
  def test_iban_lv
    ...
    assert_equal(21, account.length)
    assert_match account, /^#{IBAN_HEADER}[A-Z]{4}[A-Z0-9]{13}$/
  end
  ...
  def test_iban_md
    ...
    assert_equal(24, account.length)
    assert_match account, /^#{IBAN_HEADER}[A-Z]{2}[A-Z0-9]{18}$/
  end
  ...
  def test_iban_mk
    ...
    assert_match account, /^#{IBAN_HEADER}\d{3}[A-Z0-9]{10}\d{2}$/
  end
  ...
  def test_iban_mr
    ...
    assert_equal(27, account.length)
    assert_match account, /^#{IBAN_HEADER}\d{23}$/
  end
  ...
  def test_iban_mt
    ...
    assert_match account, /^#{IBAN_HEADER}[A-Z]{4}\d{5}[A-Z0-9]{18}$/
  end
  ...
  def test_iban_mu
    ...
    assert_equal(30, account.length)
    assert_match account, /^#{IBAN_HEADER}[A-Z]{4}\d{19}[A-Z]{3}$/
  end
  ...
  def test_iban_nl
    ...
    assert_equal(18, account.length)
    assert_match account, /^#{IBAN_HEADER}[A-Z]{4}\d{10}$/
  end
  ...
  def test_iban_no
    ...
    assert_match account, /^#{IBAN_HEADER}\d{11}$/
  end
  ...
  def test_iban_pk
    ...
    assert_equal(24, account.length)
    assert_match account, /^#{IBAN_HEADER}[A-Z]{4}[A-Z0-9]{16}$/
  end
  ...
  def test_iban_ps
    ...
    assert_equal(29, account.length)
    assert_match account, /^#{IBAN_HEADER}[A-Z]{4}[A-Z0-9]{21}$/
  end
  ...
  def test_iban_pt
    ...
    assert_match account, /^#{IBAN_HEADER}\d{21}$/
  end
  ...
  def test_iban_sa
    ...
    assert_equal(24, account.length)
    assert_match account, /^#{IBAN_HEADER}\d{2}[A-Z0-9]{18}$/
  end
  ...
  def test_iban_si
    ...
    assert_equal(19, account.length)
    assert_match account, /^#{IBAN_HEADER}\d{15}$/
  end
  ...
  def test_iban_tr
    ...
    assert_equal(26, account.length)
    assert_match account, /^#{IBAN_HEADER}\d{5}[A-Z0-9]{17}$/
  end
  ...
  def test_iban_ua
    ...
    assert_equal(29, account.length)
    assert_match account, /^#{IBAN_HEADER}\d{25}$/
  end
  ...
  def test_iban_vg
    ...
    assert_equal(24, account.length)
    assert_match account, /^#{IBAN_HEADER}[A-Z]{4}\d{16}$/
  end
