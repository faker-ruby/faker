...
class TestPlaceholdit < Test::Unit::TestCase
  ...
  def test_avatar_background_with_correct_six_char_hex
    assert_match %r{https://placehold\.co/(.+)/ffffff\.(jpg?)}, @tester.image(size: '300x300', format: 'jpg', background_color: 'ffffff')
  end

  def test_avatar_background_with_correct_three_char_hex
    assert_match %r{https://placehold\.co/(.+)/fff\.(jpg?)}, @tester.image(size: '300x300', format: 'jpg', background_color: 'fff')
  end

  def test_avatar_background_with_random_color
    assert_match %r{https://placehold\.co/(.+)/[a-f0-9]{6}\.(jpg?)}, @tester.image(size: '300x300', format: 'jpg', background_color: :random)
  end
  ...
  def test_avatar_font_color_with_correct_six_char_hex
    assert_match %r{https://placehold\.co/(.+)/ffffff/000000\.(jpg?)}, @tester.image(size: '300x300', format: 'jpg', background_color: 'ffffff', text_color: '000000')
  end

  def test_avatar_font_color_with_correct_three_char_hex
    assert_match %r{https://placehold\.co/(.+)/fff/000\.(jpg?)}, @tester.image(size: '300x300', format: 'jpg', background_color: 'fff', text_color: '000')
  end

  def test_avatar_font_color_with_random_color
    assert_match %r{https://placehold\.co/(.+)/fff/[a-f0-9]{6}\.(jpg?)}, @tester.image(size: '300x300', format: 'jpg', background_color: 'fff', text_color: :random)
  end
