...
class TestPlaceholdit < Test::Unit::TestCase
  ...
  def test_avatar_with_supported_format
    assert_match @tester.image(size: '300x300', format: 'jpg'), %r{https://via\.placeholder\.com/(.+)(jpg?)}
  end
  ...
  def test_avatar_background_with_correct_six_char_hex
    assert_match @tester.image(size: '300x300', format: 'jpg', background_color: 'ffffff'), %r{https://via\.placeholder\.com/(.+)(jpg?)/ffffff}
  end

  def test_avatar_background_with_correct_three_char_hex
    assert_match @tester.image(size: '300x300', format: 'jpg', background_color: 'fff'), %r{https://via\.placeholder\.com/(.+)(jpg?)/fff}
  end

  def test_avatar_background_with_random_color
    assert_match @tester.image(size: '300x300', format: 'jpg', background_color: :random), %r{https://via\.placeholder\.com/(.+)(jpg?)/[a-f0-9]{6}}
  end
  ...
  def test_avatar_font_color_with_correct_six_char_hex
    assert_match @tester.image(size: '300x300', format: 'jpg', background_color: 'ffffff', text_color: '000000'), %r{https://via\.placeholder\.com/(.+)(jpg?)/ffffff/000000}
  end

  def test_avatar_font_color_with_correct_three_char_hex
    assert_match @tester.image(size: '300x300', format: 'jpg', background_color: 'fff', text_color: '000'), %r{https://via\.placeholder\.com/(.+)(jpg?)/fff}
  end

  def test_avatar_font_color_with_random_color
    assert_match @tester.image(size: '300x300', format: 'jpg', background_color: 'fff', text_color: :random), %r{https://via\.placeholder\.com/(.+)(jpg?)/fff/[a-f0-9]{6}}
  end
  ...
  def test_text_not_present
    assert_match @tester.image(size: '300x300', format: 'jpg', background_color: 'fff', text_color: '000'), %r{https://via\.placeholder\.com/[^\\?]+$}
  end

  def test_text_present
    assert_match @tester.image(size: '300x300', format: 'jpg', background_color: 'fff', text_color: '000', text: 'hello'), %r{https://via\.placeholder\.com/(.+)\?text=hello}
  end
end
