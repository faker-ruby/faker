...
class TestFakerTime < Test::Unit::TestCase
  ...
  def test_forward
    ...
    100.times do
      random_time = @tester.forward(10)
      assert random_time > today, "Expected > \"#{today}\", but got #{random_time}"
    end
  end
  ...
  def test_backward
    ...
    100.times do
      random_time = @tester.backward(10)
      assert random_time < tomorrow, "Expected < \"#{tomorrow}\", but got #{random_time}"
    end
  end
  ...
  def test_time_period
    ...
    100.times do
      ...
      [random_backward, random_forward].each_with_index do |result, index|
